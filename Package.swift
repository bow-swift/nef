...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "NefSwiftPlayground", dependencies: ["Bow", "BowEffects", "Swiftline", "NefModels"], path: "project/Component/NefSwiftPlayground", publicHeadersPath: "Support Files"),
