...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "NefCore", dependencies: ["NefModels", "NefCommon"], path: "project/Core", publicHeadersPath: "Support Files"),
        ...
        .target(name: "NefPlayground", dependencies: ["NefModels", "NefCommon"], path: "project/Component/NefPlayground", publicHeadersPath: "Support Files"),
